...
public class CommUtil {
    ...
    public static String getAvailableStoragePath() {
        ...
        if (CommUtil.isNotBlank(sdCardPath)) {
            sb.append(sdCardPath).append("/data/").append(CourseDesignAPP.getInstance().getPackageName()).append('/');
        } else {
            sb.append(CourseDesignAPP.getInstance().getFilesDir()).append("/data/");
        }
        return sb.toString();
    }
